<template>
  <nav class="header-nav-wrapper">
    ...
    <section id="site-header">
      <header class="header-nav container-wide">
        <nav>
              <div class="header-nav__element">
                <a class="header-nav__logo" href="https://www.teradata.com/" target="_blank">
                  
                  <svg id="teradata-logo" style="width: 148px; height: 28px;" viewBox="0 0 148 28" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <span v-if="title" class="header-nav__logo-text">{{title}}</span>
                </a>
              </div>
              <div class="header-nav__element">
                <ul class="header-nav__main-menu">
                  <slot name="navigation"></slot>
                </ul>
              </div>
              
              <div class="header-nav__actions header-nav__element">
      ...
      <header class="header-nav-mobile">
        <nav class="d-flex custom-justify-content-between align-items-center px-6 shadow--s">
          <a class="header-nav__logo d-flex align-items-center" href="/">
            <div>
              <!-- <img class="teradata-logo" src='img/TD-Logo.svg' alt="" title=""> -->
            </div>
          </a>
          <a href="http://developers.teradata.com/" class="developers">Developers</a>
          <ul class="header-nav-mobile__top-links">
            <li>
              <button id="showMenu" role="button" aria-label="Click or Press enter to open menu" tabindex="0"
          ...
          <div class="header-nav-mobile__menu-search" style="display: none;">
            <div class="header-nav-mobile__menu-search__input">
              ...
              <button class="d-flex align-items-center justify-content-center"
                data-celebrus="Header - Search Mobile (Display Only)" data-gtm-action="search click">
          ...
          <section class="header-nav-mobile__menu-listing display-menu sidenav">
            <ul class="container-wide header-nav-mobile__menu-listing-ul">
              <li class="header-nav-mobile__menu-listing__item has-sub-items">
                <header data-celebrus="Mobile Main Menu - Who we help" data-gtm-category="Header"
                  data-gtm-action="main nav click" data-gtm-label="Who we help"
                  class="d-flex justify-content-between align-items-center border-bottom-light">
                  <div class="header-nav-mobile__menu-listing__header nav-1">Getting started</div>
                </header>
              </li>

              <li class="border-bottom-light">
                <div>
                  <button id="toggleButtonDocs"
                    class="py-4 nav-1 d-flex justify-content-between align-items-center w-100">Docs
                    <span class="caret caret--slate"></span>
                  </button>
                  <div class="slide-up-down__container hidden"
                    style="--content-height: 94; transition: height 500ms ease-in-out 0s;">
                    <ul class="ps-3">
                      <li>
                        <a class="nav-2 py-4 d-block color-slate" href="/Getting-Started/Pricing">VantageCloud Lake
                          Documentation</a>
                      </li>
                      <li>
                        <a class="nav-2 py-4 d-block color-slate" href="/Getting-Started/Pricing/Calculator">All
                          Documentation</a>
                      </li>
                    </ul>
                  </div>
